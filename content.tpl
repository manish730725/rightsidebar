		...
		<div class="inside-container point1 clearfix">
			...
			<div class="row">
				...
				{if $side_bar_exists && ($blocks.left || $pageInfo.Controller == 'listing_details')}
					<aside class="left {if $pageInfo.Controller == 'listing_details' }order-2 col-lg-4{else} {if $pageInfo.Controller == 'listing_type' }listing_left  {/if}col-lg-3{/if}">
						{strip}
				...
				<!-- right blocks area on home page -->

				{if $blocks.right }
					<aside class="right order-3  {if $pageInfo.Controller == 'listing_details'}col-lg-4{else}col-lg-3 {if $pageInfo.Controller == 'listing_type' }listing_right  {/if} {/if}">
						{strip}
						{if $pageInfo.Controller == 'listing_details'}{include file='blocks'|cat:$smarty.const.RL_DS|cat:'listing_details_sidebar.tpl'}{/if}
				...
				<section id="content" class="{if $side_bar_exists}{if $pageInfo.Controller == 'listing_details'}order-1 col-lg-8{else} {if $blocks.right}col-lg-6 {if $pageInfo.Controller == 'listing_type' }listing_center  {/if} {else}col-lg-9{/if}{/if}{else}{if $blocks.right}col-lg-9{else}col-lg-12{/if}{/if}">
